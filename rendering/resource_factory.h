...
public:
	...
	void createUniformBuffers(uint32_t swapchainSize, BatchResource& batchResource);
	void createDescriptorSets(uint32_t swapchainSize, VkDescriptorPool descriptorPool, VkDescriptorSetLayout descriptorSetLayout, BatchResource& batchResource);
