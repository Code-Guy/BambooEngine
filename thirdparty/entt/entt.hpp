...
public:
    ...
    [[nodiscard]] iterator begin() const ENTT_NOEXCEPT {
        const typename traits_type::difference_type pos = static_cast<uint32_t>(packed.size());
...
public:
    ...
    [[nodiscard]] iterator begin() ENTT_NOEXCEPT {
        const typename traits_type::difference_type pos = static_cast<uint32_t>(underlying_type::size());
